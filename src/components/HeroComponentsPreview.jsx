  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between">
          <div className="flex">
            <div className="relative inline-flex">
              ...
              {/* <span className="absolute bottom-0 right-0 h-3 w-3 rounded-full border bg-green-600 dark:border-slate-900 dark:bg-green-600 dark:text-slate-100"></span> */}
              <img
            ...
            <div className="ml-4 flex flex-col gap-y-2">
              ...
              <span className="text-xs text-slate-400">Business metrics analyzer</span>
            </div>
          </div>
      ...
      <div className="flex flex-col items-end justify-between gap-y-4 sm:gap-y-0">
        ...
        <button className="inline-flex items-center gap-x-1 rounded-lg bg-slate-200 p-2 text-xs text-slate-600 hover:bg-blue-600 hover:text-slate-200 focus:outline-none focus:ring focus:ring-blue-300 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-blue-600 sm:text-sm">
          ...
          <svg
            ...
            className="animate-spin inline h-4 w-4"
            viewBox="0 0 24 24"
            strokeWidth="2"
            stroke="currentColor"
            fill="none"
      ...
      <div className="col-span-2 flex flex-col sm:col-span-1 sm:max-w-xs">
        <a className="cursor-pointer rounded-lg border-2 border-slate-300 bg-slate-50 transition-colors hover:border-blue-600 dark:border-slate-300/20 dark:bg-slate-900 dark:hover:border-blue-600">
      ...
      <div className="col-span-2 rounded-lg bg-slate-50 shadow dark:bg-slate-900">
        <div className="flex w-full items-center justify-between space-x-6 p-6">
          <button className="group flex-1 truncate">
            ...
            <p className="mt-1 truncate text-sm text-slate-500 animate-type">
      ...
      {/* <form className="col-span-2">
        <div className="mb-4 w-full max-w-3xl rounded-lg bg-slate-200 dark:bg-slate-900">
          <div className="rounded-lg rounded-b-none border border-slate-300 bg-slate-50 px-2 py-2 dark:border-slate-700 dark:bg-slate-800">
            <label for="prompt-input" className="sr-only">
              Enter your prompt
            </label>
            <textarea
              id="prompt-input"
              rows="4"
              className="w-full border-0 bg-slate-50 px-0 text-base text-slate-900 focus:outline-none focus:ring-0 dark:bg-slate-800 dark:text-slate-200 dark:placeholder-slate-400"
          ...
          <div className="flex items-center justify-between px-2 py-2">
            ...
            <button
              type="button"
              className="inline-flex items-center gap-x-2 rounded-lg bg-blue-600 px-4 py-3 text-center text-sm font-medium text-slate-50 hover:bg-blue-800 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 sm:text-base"
            >
              Generate
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="col-span-2 flex-1 overflow-y-auto rounded-xl bg-slate-200 p-4 text-sm text-slate-900 dark:bg-slate-800 dark:text-slate-200 sm:text-base">
        ...
        <div className="mb-4 flex rounded-xl bg-slate-200 px-4 py-4 dark:bg-slate-900">
          <img
            className="mr-2 flex h-8 w-8 rounded-full sm:mr-4"
