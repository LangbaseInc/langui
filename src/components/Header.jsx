...
export default function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-slate-200/10 bg-slate-900">
      <Container classNames="relative max-w-screen-xl px-4 flex h-16 items-center justify-between gap-4 sm:gap-8">
